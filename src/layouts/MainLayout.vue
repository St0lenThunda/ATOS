  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-toolbar-title>
          ATOS <span class="text-subtitle1">- a thought organization system</span>
        </q-toolbar-title>

        <q-space />
        <div>Quasar v{{ $q.version }}</div>
      </q-toolbar>
      <q-toolbar class="bg-info" inset v-if="leftDrawerOpen">
    ...
    <q-drawer v-model="leftDrawerOpen" class="drawer-container" show-if-above bordered>
      <q-list>
